...
if(isset($_POST['submit'])){
   ...
   $id_compte = $fetch_profile['Id_compte'];
   ...
   if($old_pass == $empty_pass){
      ...
      if($new_pass != $empty_pass){
         $update_admin_pass = $conn->prepare("UPDATE `compte` SET mot_de_passe = ? WHERE id_compte = ?");
         $update_admin_pass->execute([$confirm_pass, $id_compte]);
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="hidden" name="prev_pass" value="<?= $fetch_compte['mot_de_passe']; ?>">
