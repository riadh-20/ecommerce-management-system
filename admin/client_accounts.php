...
<section class="accounts">
   ...
   <div class="box">
      ...
      <a href="client_accounts.php?delete=<?= $fetch_C['id_compte']; ?>" onclick="return confirm('delete this account? the user related information will also be deleted!')" class="delete-btn">delete</a>
   </div>
   <?php
         }
      }else{
