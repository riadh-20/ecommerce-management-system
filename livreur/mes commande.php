...
<head>
   ...
   function confirmAndGoToOrderDetails(orderId) {
       window.location.href = 'valider_signaler.php?id=' + orderId;
   }
   </script>
...
<h1 class="heading">mes commande</h1>

<div class="box-container">

   <?php
   $stmt = $conn->prepare("SELECT * FROM `commande_client` WHERE etat_commande = 'a livrer' AND id_livreur = ?");
